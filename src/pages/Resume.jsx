      ...
      <div className="resume--header">
        ...
        <div className="resume--about">
          ...
          <p>
            ...
            an eye on details and in love with CSS.With a background in office
            furniture, design and sales. Strong communication and problem
            solving skills.{" "}
          </p>
        </div>
      </div>
      <main className="resume--main--container">
        <div>
          ...
          <p>
            ...
            furniture company. Working as a designer I provided support to sales
            managers in design concepts, space planning, visualization and
            tenders. As a creative person layouts and visualisation have always
            been my favourite. But my logical side was missing something.
          </p>
          <p>
            In 2022 I had the chance to join a Frontend Dev Cohort for woman
            from all around the world and realized that as a frontend developer
            both my creative and logical side can be satisfied. Since the day of
            stepping in the world of coding I could not stop learning and
            immediately joined the Frontend Career Path of Scrimba. This course
            was a game changer for me. With tons of coding challenges and real
            world solo projects it has really challenged me again and again and
            made me realize how motivated I am.
          </p>
          <p>
            Now I feel ready to get more adventurous and after all of these real
            world solo projects finally start to work as a frontend developer.
          </p>
        </div>
      </main>
